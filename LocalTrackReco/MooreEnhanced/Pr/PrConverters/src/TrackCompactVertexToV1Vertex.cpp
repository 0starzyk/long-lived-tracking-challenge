...
namespace LHCb::Converters::TrackCompactVertex {
   ...
   * LHCb::Pr::Fitted::Forward::<something>.
   *
  ...
  DECLARE_COMPONENT_WITH_ID(
      VectorOf2TrackPrFittedCompactVertexToVectorOfRecVertex<LHCb::Pr::Fitted::Forward::TracksWithMuonID>,
      "LHCb__Converters__TrackCompactVertex__VectorOf2TrackPrFittedWithMuonIDCompactVertexToVectorOfRecVertex" )
  DECLARE_COMPONENT_WITH_ID(
      VectorOf2TrackPrFittedCompactVertexToVectorOfRecVertex<LHCb::Pr::Fitted::Forward::TracksWithPVs>,
