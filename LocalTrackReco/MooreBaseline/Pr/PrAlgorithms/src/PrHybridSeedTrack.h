...
namespace LHCb::Pr::Hybrid {
  ...
  using SeedTrackHitsX          = boost::container::static_vector<ModPrHit, LHCb::Detector::FT::Numbers::NFTXLayers>;
  using SeedTrackHitsXIter      = SeedTrackHitsX::iterator;
  using SeedTrackHitsXConstIter = SeedTrackHitsX::const_iterator;
  using SeedTrackHits           = boost::container::static_vector<ModPrHit, LHCb::Detector::FT::Numbers::NFTLayers>;
  ...
  private:
    ...
    std::array<float, LHCb::Detector::FT::Numbers::NFTXLayers> m_chi2Hits{};
  };
  ...
  private:
    ...
    std::array<float, LHCb::Detector::FT::Numbers::NFTLayers> m_chi2Hits{};
  };
