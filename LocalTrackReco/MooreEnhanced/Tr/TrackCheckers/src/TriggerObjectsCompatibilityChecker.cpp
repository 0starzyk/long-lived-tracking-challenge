...
class TriggerObjectsCompatibilityChecker final
...
public:
  TriggerObjectsCompatibilityChecker( const std::string& name, ISvcLocator* pSvcLocator )
  ...
  mutable Gaudi::Accumulators::Histogram<1, Gaudi::Accumulators::atomicity::full, int> m_fitted_track{
      this, "fitted_track", "fitted track", {2, 0, 2}};
  ...
  mutable Gaudi::Accumulators::Histogram<1, Gaudi::Accumulators::atomicity::full, int> m_numPVs_hlt1{
      this, "number_reconstructed_PVs_hlt1", "number_reconstructed_PVs_hlt1", {50, 0, 50}};
  mutable Gaudi::Accumulators::Histogram<1, Gaudi::Accumulators::atomicity::full, int> m_numPVs_hlt2{
      this, "number_reconstructed_PVs_hlt2", "number_reconstructed_PVs_hlt2", {50, 0, 50}};
  mutable Gaudi::Accumulators::Histogram<1> m_probChi2_hlt1{this, "probChi2_hlt1", "probChi2_hlt1", {1000, 0, 1.}};
  mutable Gaudi::Accumulators::Histogram<1> m_probChi2_hlt2{this, "probChi2_hlt2", "probChi2_hlt2", {1000, 0, 1.}};

  mutable Gaudi::Accumulators::Histogram<1> m_chi2_hlt1{this, "chi2_hlt1", "chi2_hlt1", {2000, 0, 200}};
  mutable Gaudi::Accumulators::Histogram<1> m_chi2_hlt2{this, "chi2_hlt2", "chi2_hlt2", {2000, 0, 200}};

  mutable Gaudi::Accumulators::Histogram<1, Gaudi::Accumulators::atomicity::full, int> m_ndof_hlt1{
      this, "ndof_hlt1", "ndof_hlt1", {2, 0, 2}};
  mutable Gaudi::Accumulators::Histogram<1, Gaudi::Accumulators::atomicity::full, int> m_ndof_hlt2{
      this, "ndof_hlt2", "ndof_hlt2", {2, 0, 2}};

  mutable Gaudi::Accumulators::Histogram<1> m_chi2_ndof_hlt1{this, "chi2_ndof_hlt1", "chi2_ndof_hlt1", {500, 0, 50}};
  mutable Gaudi::Accumulators::Histogram<1> m_chi2_ndof_hlt2{this, "chi2_ndof_hlt2", "chi2_ndof_hlt2", {500, 0, 50}};
  ...
  mutable Gaudi::Accumulators::Histogram<1> m_deltaX{
      this, "deltaX_first_state", "hlt2 - hlt1 x first state", {1000, -0.2, 0.2}};
  mutable Gaudi::Accumulators::Histogram<1> m_deltaY{
      this, "deltaY_first_state", "hlt2 - hlt1 y firstate", {1000, -0.2, 0.2}};
  mutable Gaudi::Accumulators::Histogram<1> m_deltaZ{
      this, "deltaZ_first_state", "hlt2 - hlt1 z firstate", {1000, -10., 10.}};
  mutable Gaudi::Accumulators::Histogram<1> m_deltaTX{
      this, "deltaTX_first_state", "hlt2 - hlt1 tx firstate", {1000, -0.01, 0.01}};
  mutable Gaudi::Accumulators::Histogram<1> m_deltaTY{
      this, "deltaTY_first_state", "hlt2 - hlt1 ty firstate", {1000, -0.01, 0.01}};
  mutable Gaudi::Accumulators::Histogram<1> m_deltaQOP{
      this, "deltaQOP_first_state", "hlt2 - hlt1 qop firstate", {1000, -0.0001, 0.0001}};

  mutable Gaudi::Accumulators::Histogram<2> m_2d_X{
      this, "x_first_state_2d", "firstate_x;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_2d_Y{
      this, "y_first_state_2d", "firstate_y;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_2d_Z{
      this, "z_first_state_2d", "firstate_z;hlt1;hlt2", {{1000, -200., 600.}, {1000, -200., 600.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_2d_TX{
      this, "tx_first_state_2d", "firstate_tx;hlt1;hlt2", {{1000, -0.3, 0.3}, {1000, -0.3, 0.3}}};
  mutable Gaudi::Accumulators::Histogram<2> m_2d_TY{
      this, "ty_first_state_2d", "firstate_ty;hlt1;hlt2", {{1000, -0.2, 0.2}, {1000, -0.2, 0.2}}};
  mutable Gaudi::Accumulators::Histogram<2> m_2d_QOP{
      this, "qop_first_state_2d", "firstate_qop;hlt1;hlt2", {{1000, -0.001, 0.001}, {1000, -0.001, 0.001}}};

  mutable Gaudi::Accumulators::Histogram<2> m_2d_PT{
      this, "pt_first_state_2d", "firstate_pt;hlt1;hlt2", {{1000, 0., 10000.}, {1000, 0., 10000.}}};
  ...
  mutable Gaudi::Accumulators::Histogram<2> m_IP3D{
      this, "recIP3D", "recIP3D;hlt1;hlt2", {{100, 0., 1.}, {100, 0., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_IPx{this, "recIPx", "recIPx;hlt1;hlt2", {{100, -1., 1.}, {100, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_IPy{this, "recIPy", "recIPy;hlt1;hlt2", {{100, -1., 1.}, {100, -1., 1.}}};
  ...
  mutable Gaudi::Accumulators::Histogram<2> m_IPxErr{
      this, "recIPxErr", "recIPxErr;hlt1;hlt2", {{100, 0., 0.5}, {100, 0., 0.5}}};
  mutable Gaudi::Accumulators::Histogram<2> m_IPyErr{
      this, "recIPyErr", "recIPyErr;hlt1;hlt2", {{100, 0., 0.5}, {100, 0., 0.5}}};

  mutable Gaudi::Accumulators::Histogram<1> m_deltaIPChi2{this, "delta_recIPChi2", "delta_recIPChi2", {500, -10., 10.}};
  mutable Gaudi::Accumulators::Histogram<2> m_IPChi2{
      this, "recIPChi2", "recIPChi2;hlt1;hlt2", {{500, 0., 20.}, {500, 0., 20.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_IPChi2_zoom{
      this, "recIPChi2_zoom", "recIPChi2_zoom;hlt1;hlt2", {{500, 0., 2.}, {500, 0., 2.}}};

  mutable Gaudi::Accumulators::Histogram<2, Gaudi::Accumulators::atomicity::full, int> m_nTracksPerPV{
      this, "nTracksPerPV", "nTracksPV;hlt1;hlt2", {{50, 0, 50}, {50, 0, 50}}};
  mutable Gaudi::Accumulators::Histogram<2, Gaudi::Accumulators::atomicity::full, int> m_nTracks{
      this, "nTracks", "nTracks;hlt1;hlt2", {{100, 0, 100}, {100, 0, 100}}};

  mutable Gaudi::Accumulators::Histogram<2> m_PV_X{
      this, "x_PV", "PVx;hlt1;hlt2", {{1000, -0.2, 0.2}, {1000, -0.2, 0.2}}};
  mutable Gaudi::Accumulators::Histogram<2> m_PV_Y{
      this, "y_PV", "PVy;hlt1;hlt2", {{1000, -0.2, 0.2}, {1000, -0.2, 0.2}}};
  mutable Gaudi::Accumulators::Histogram<2> m_PV_Z{
      this, "z_PV", "PVz;hlt1;hlt2", {{1000, -200., 200.}, {1000, -200., 200.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov00{
      this, "cov00_PV", "PVcov00;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov01{
      this, "cov01_PV", "PVcov01;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov02{
      this, "cov02_PV", "PVcov02;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov11{
      this, "cov11_PV", "PVcov11;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov12{
      this, "cov12_PV", "PVcov12;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_PV_cov22{
      this, "cov22_PV", "PVcov12;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_X{
      this, "x_stAtVtx", "stAtVtx_x;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_Y{
      this, "y_stAtVtx", "stAtVtx_y;hlt1;hlt2", {{1000, -1., 1.}, {1000, -1., 1.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_Z{
      this, "z_stAtVtx", "stAtVtx_z;hlt1;hlt2", {{1000, -200., 200.}, {1000, -200., 200.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_TX{
      this, "tx_stAtVtx", "stAtVtx_tx;hlt1;hlt2", {{1000, -0.3, 0.3}, {1000, -0.3, 0.3}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_TY{
      this, "ty_stAtVtx", "stAtVtx_ty;hlt1;hlt2", {{1000, -0.2, 0.2}, {1000, -0.2, 0.2}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_QOP{
      this, "qop_stAtVtx", "stAtVtx_qop;hlt1;hlt2", {{1000, -0.001, 0.001}, {1000, -0.001, 0.001}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov00{
      this, "cov00_stAtVtx", "stAtVtxcov00;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov01{
      this, "cov01_stAtVtx", "stAtVtxcov01;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov02{
      this, "cov02_stAtVtx", "stAtVtxcov02;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov03{
      this, "cov03_stAtVtx", "stAtVtxcov03;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov04{
      this, "cov04_stAtVtx", "stAtVtxcov04;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov11{
      this, "cov11_stAtVtx", "stAtVtxcov11;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov12{
      this, "cov12_stAtVtx", "stAtVtxcov12;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov13{
      this, "cov13_stAtVtx", "stAtVtxcov13;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov14{
      this, "cov14_stAtVtx", "stAtVtxcov14;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov22{
      this, "cov22_stAtVtx", "stAtVtxcov22;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov23{
      this, "cov23_stAtVtx", "stAtVtxcov23;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov24{
      this, "cov24_stAtVtx", "stAtVtxcov24;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov33{
      this, "cov33_stAtVtx", "stAtVtxcov33;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};
  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov34{
      this, "cov34_stAtVtx", "stAtVtxcov34;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};

  mutable Gaudi::Accumulators::Histogram<2> m_stAtVtx_cov44{
      this, "cov44_stAtVtx", "stAtVtxcov44;hlt1;hlt2", {{1000, -100., 100.}, {1000, -100., 100.}}};

  mutable Gaudi::Accumulators::Histogram<2, Gaudi::Accumulators::atomicity::full, int> m_nVPHits{
      this, "nVPHits", "nVPHits;hlt1;hlt2", {{20, 0, 20}, {20, 0, 20}}};
  mutable Gaudi::Accumulators::Histogram<2, Gaudi::Accumulators::atomicity::full, int> m_nUTHits{
      this, "nUTHits", "nUTHits;hlt1;hlt2", {{4, 0, 4}, {4, 0, 4}}};
  mutable Gaudi::Accumulators::Histogram<2, Gaudi::Accumulators::atomicity::full, int> m_nFTHits{
      this, "nFTHits", "nFTHits;hlt1;hlt2", {{4, 8, 12}, {4, 8, 12}}};
};

DECLARE_COMPONENT( TriggerObjectsCompatibilityChecker )
void TriggerObjectsCompatibilityChecker::
  ...
  for ( const auto& hlt2_track : hlt2_tracks ) {
    ...
    for ( const auto& thispv : hlt2_pvs ) {
      ...
      if ( hlt2_recpv == 0 || ip2 < hlt2_bestip2 ) {
        hlt2_bestip2 = ip2;
        hlt2_recpv   = thispv;
      }
    }
