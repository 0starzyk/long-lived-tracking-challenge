...
#include "/data3/TrackReco/Models/GhostClassifier.cpp"
...
class PrLongLivedTracking
    : public LHCb::Algorithm::Transformer<LHCb::Pr::Downstream::Tracks(
                                          ...
                                          LHCb::DetDesc::usesConditions<LHCb::UTDAQ::GeomCache, DeMagnet>> {
...
private:
  ...
  //=============================================================================
  // Evaluate the Ghost Classifier for a preselection of seed tracks
  //=============================================================================
