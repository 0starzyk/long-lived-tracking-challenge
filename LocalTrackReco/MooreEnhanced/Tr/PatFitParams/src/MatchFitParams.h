 ...
 * Velo and T-station information is used. Some TT information is calculated, but not used at the moment.
 *
 ...
 *  @code
 *  def doIt():
 *      GaudiSequencer("BrunelSequencer").Members =  [ MatchFitParams("MatchFitParams", ZRef = 8520, zMagnetParams = [
