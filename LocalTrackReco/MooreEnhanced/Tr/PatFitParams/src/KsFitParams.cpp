...
DECLARE_COMPONENT( KsFitParams )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
KsFitParams::KsFitParams( const std::string& name, ISvcLocator* pSvcLocator )
...
StatusCode KsFitParams::execute() {
  ...
  for ( pItr = partCtnr->begin(); partCtnr->end() != pItr; pItr++ ) {
    ...
    if ( 211 == abs( part->particleID().pid() ) ) {
      ...
      tTrack->column( "PredMom", m_momPar.sum() / dSlope ).ignore( /* AUTOMATICALLY ADDED FOR gaudi/Gaudi!763 */ );
